...
class ApiManagerr {
    ...
    func getListCrypto(completed: @escaping(Result<[String: Any], APError1>)->Void) {
...
struct PreData {
    static let crypto1 = CryptoModel(uuid: "", symbol: "", name: "", color: "", iconURL: "", marketCap: "", price: "", listedAt: 1, tier: 2, change: <#T##String#>, rank: 2, sparkline: [""], lowVolume: true, coinrankingURL: "", the24HVolume: "", btcPrice: "")
